...
def get_method_specs(method_names: tuple[str, ...] | None = None) -> tuple[MethodSpec, ...]:
    names = method_names or PAPER_METHOD_NAMES
    return tuple(METHOD_SPEC_BY_NAME[name] for name in names)
